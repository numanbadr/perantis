...
# HOW TO RUN
# Run on terminal: (env) C:\Users\User\Documents\cv-master\neuPrj\rawdata>python folder-to-dataset.py screenshot
# .jsons is already in 'screenshot' folder, can contain other files but cannot have any folder inside the 'screenshot' folder

'''
STEPS:
1. Make a subfolder inside rawdata (i.e rawdata\newfolder)
2. Put the jsons inside the newfolder
3. Run this code (refer How To Run above)
4. Move the newly created training folder from rawdata to the newfolder
'''
